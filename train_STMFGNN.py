...
import argparse
import configparser
# from model.DSTAGNN_my_with_tatoutput import make_model
from model.STMFGNN_my_258 import make_model
# from model.DSTAGNN_my_with_dilation import make_model
from lib.dataloader import load_weighted_adjacency_matrix, load_weighted_adjacency_matrix2, load_PA
from lib.utils1 import load_graphdata_channel1, get_adjacency_matrix2, compute_val_loss_mstgcn, \
...
"""
parser.add_argument("--config", default='configurations/PEMS08_dstagnn.conf', type=str,
                    help="configuration file path")
...
# 为PEMS的数据准备的函数 专为mstgcn，astgcn设计
...
if dataset_name == 'PEMS04' or 'PEMS08' or 'PEMS07' or 'PEMS03':
    ...
    print(f'id_filename:{id_filename}')
else:
...
net = make_model(DEVICE, num_of_d, nb_block, in_channels, K, nb_chev_filter, nb_time_filter, time_strides, adj_merge,
                 adj_pa, adj_TMD, adj_org, num_for_predict, len_input, num_of_vertices, d_model, d_k, d_v, n_heads)
